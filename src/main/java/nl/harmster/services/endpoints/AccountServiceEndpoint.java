package nl.harmster.services.endpoints;
...
import nl.harmster.services.AccountService;  
import nl.harmster.Account;  
import nl.harmster.webservices.accountservice.AccountDetailsRequest;  
import nl.harmster.webservices.accountservice.AccountDetailsResponse;  
 /**  
 ...
 {  
      private static final String TARGET_NAMESPACE = "http://nl/harmster/webservices/accountservice";  
      @Autowired  
